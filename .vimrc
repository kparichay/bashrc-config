" Load the defaults.vim for base settings
...
" COLORS
""""
" enable syntax processing, confusion between on and enable is to use enable
...
" TABS and SPACES
""""
" number of visual spaces per TAB when reading files
set tabstop=2
" nunber of spaces in TAB when editing files (press TAB, BACKSPACE)
set softtabstop=2
...
" show line numbers
set number
" show command in bottom (TODO: check if useful enough)
set showcmd
" highlight current line
set cursorline
" load filetype specific indent, plugin files
filetype plugin indent on
" completion of command menu
set wildmenu
...
nnoremap <space> za
" foldmethod based on indent/syntax
set foldmethod=syntax
autocmd FileType python setlocal foldmethod=indent
autocmd FileType shell setlocal foldmethod=indent
...
" Movement
""""
" move vertically by visual line TODO: is this needed
nnoremap j gj
nnoremap k gk
...
set scrolloff=5                                                 " to show 5 lines around the scroll
set showmatch
set title
set tags=tags
set fdm=syntax
